...
- <Link to="/development/philosophy/">Development Philosophy</Link> (and <Link to="/sdk/philosophy/">SDK Development Philosophy</Link>)
...
- <Link to="/development/python-dependencies/">Python Dependencies</Link>
- <Link to="/development/docs/">Documentation Guide</Link>
- <Link to="/application/translations/">Translations</Link>
